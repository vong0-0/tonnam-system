    ...
    <Card className='shadow-md'>
      <CardContent>
        <div>
          ...
          <div className='w-full flex items-center justify-between gap-2'>
            <span className='text-xl font-bold text-zinc-900'>{bill.short_id || '-'}</span>
            <span className='text-[22px] font-bold text-status-available-fg'>{formatNumber(bill.total_amount * 10) || 0} ກີບ</span>
          </div>
        </div>
